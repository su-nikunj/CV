...
\begin{cvevent}[2017][2019]
	...
	\begin{itemize}
		...
		\item Applied Google's style-transfer \cvhl{deep learning} model to auto-generate product art variations, expanding catalog visuals without manual artwork.
		\item Built a browser-side \cvhl{3D} rendering pipeline that produces product videos client-side, removing the need for offline rendering.
	\end{itemize}
\end{cvevent}
